...
import Computer from "@site/static/img/lading-page/computer.svg";
import Mobile from "@site/static/img/lading-page/mobile.svg";
...
export default function Home(): ReactNode {
  ...
  const [viewOption, setViewOption] = useState<ViewOptions>('InfolightApp');
...

        {
          (
            <div className={styles.tabs}>
              <button className={`${styles.tab} ${viewOption == 'InfolightApp' ? styles.selectedTab : '' }`} onClick={() => setViewOption('InfolightApp')}>
                <Mobile />
