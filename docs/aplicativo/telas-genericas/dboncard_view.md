...
- `query/table` representa a fonte de dados do grid que será gerado, podendo ser uma *query* ou uma tabela. Essa fonte não precisa estar armazenada localmente no aplicativo, pois a `DbOnCard` opera de forma totalmente *online*.
